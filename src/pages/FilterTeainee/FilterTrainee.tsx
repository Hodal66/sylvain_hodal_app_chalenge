    ...
    <>
      <div className="ml-64 mr-1 mt-28 ">
        <div className="">
          ...
          <Select
            className="sm:text-sm border bg-gray border-solid border-bdr w-40 rounded-bt-rd"
            options={[
        ...
        <div className="flex items-center">
          <label className="relative block ">
            ...
            <span className="absolute inset-y-0 left-0 flex items-center pl-2">
              <svg
                className="h-5 w-5 fill-slate-300 text-cg"
                viewBox="-6 -6 20 20"
              >
                <AiOutlineSearch />
              </svg>
        ...
        <div className="overflow-x-auto relative my-6 mr-36 shadow-md sm:rounded-lg">
          <table className="w-full text-sm text-left text-button-color">
            <thead className="text-button-color bg-row-gray">
                ...
                <th scope="col" className="p-4">
                  <div className="flex items-center">
                    <input
                      ...
                      type="checkbox"
                      className="w-4 h-4 text-button-color bg-gray rounded border-gray-300 focus:ring-gray dark:focus:ring-cg dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                    />
            ...
            <tbody>
              <tr className="odd:bg-white even:bg-row-gray hover:bg-gray-50">
                ...
                <th
                  scope="row"
                  className="text-fb py-1 px-6 font-normal text-button-color whitespace-nowrap"
                >
                  Ange doe
                </th>
                <td className="text-fb py-1 px-6 font-normal text-button-color">
                  johhn@gmail.com
                </td>
                <td className="py-1 px-6">
                  <select
                    id="status"
                    className="border bg-row-gray border-solid border-bdr shadow-sm px-4 py-4px rounded-bt-rd focus:outline-none sm:text-sm"
                  >
              ...
              <tr className="odd:bg-white even:bg-row-gray hover:bg-gray-50">
                ...
                <td className="py-1 px-6">
                  <select
                    id="status"
                    className="border bg-row-gray border-solid border-bdr shadow-sm px-4 py-4px rounded-bt-rd focus:outline-none "
                  >
                    <option selected>Select value</option>
                    <option value="passed">Passed</option>
                    <option value="failed">Failed</option>
          ...
          <nav
            className="flex justify-between items-center pt-16 pb-10"
            aria-label="Table navigation"
          >
            <span className="pl-6 text-sm font-normal text-gray-500 dark:text-gray">
            ...
            <ul className="pr-6 inline-flex items-center -space-x-px">
              ...
              <li>
                <a
                  href="#"
                  aria-current="page"
                  className="z-10 py-2 px-3 leading-tight text-blue-600 bg-blue-50 border border-blue-300 hover:bg-blue-100 hover:text-blue-700 dark:bg-gray-700 "
                >
                  3
                </a>
              </li>
